...
module dmg_or4 #(
		parameter real L_y      = 54 + dmg_or4_param::L_y,
	...
	specify
		specparam T_rise_nor = tpd_elmore(140, 4*R_pmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		specparam T_fall_nor = tpd_elmore(140,   R_nmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		...
		(in1, in2, in3, in4 *> y) = (T_fall_nor + T_rise_y, T_rise_nor + T_fall_y);
	endspecify
