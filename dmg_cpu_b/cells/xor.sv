...
module dmg_xor #(
		parameter real L_y      = 54 + dmg_xor_param::L_y,
	...
	specify
		specparam T_rise_nor = tpd_elmore(122, 2*R_pmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		specparam T_fall_nor = tpd_elmore(122,   R_nmos_ohm(35*L_unit), C_gate_F(70*L_unit));
