...
package dmg_high_ram_param;

	import dmg_timing::L_unit;

	parameter real L_d0          = 217.8;
	parameter real L_d1          = 217.8;
	parameter real L_d2          = 217.8;
	parameter real L_d3          = 217.8;
	parameter real L_d4          = 217.8;
	parameter real L_d5          = 217.8;
	parameter real L_d6          = 217.8;
	parameter real L_d7          = 217.8;
	...
	parameter real L_wldrv_ena   =   0.0;
	...
	parameter real W_gate_a2          =  128*L_unit;
	parameter real W_gate_a3          =  128*L_unit;
	parameter real W_gate_a4          =  128*L_unit;
	parameter real W_gate_a5          =  128*L_unit;
	parameter real W_gate_a6          =  128*L_unit;
	parameter real W_gate_a2_n        =  128*L_unit;
	parameter real W_gate_a3_n        =  128*L_unit;
	parameter real W_gate_a4_n        =  128*L_unit;
	parameter real W_gate_a5_n        =  128*L_unit;
	...
	parameter real W_gate_wldrv_pch_n = 1056*L_unit;
	parameter real W_gate_wldrv_ena   =  256*L_unit;

endpackage

module dmg_high_ram #(
		parameter real L_d0      = dmg_high_ram_param::L_d0,
		parameter real L_d1      = dmg_high_ram_param::L_d1,
		parameter real L_d2      = dmg_high_ram_param::L_d2,
		parameter real L_d3      = dmg_high_ram_param::L_d3,
		parameter real L_d4      = dmg_high_ram_param::L_d4,
		parameter real L_d5      = dmg_high_ram_param::L_d5,
		parameter real L_d6      = dmg_high_ram_param::L_d6,
		parameter real L_d7      = dmg_high_ram_param::L_d7,
		parameter real W_gate_d0 = dmg_high_ram_param::W_gate_d0,
		parameter real W_gate_d1 = dmg_high_ram_param::W_gate_d1,
		parameter real W_gate_d2 = dmg_high_ram_param::W_gate_d2,
		parameter real W_gate_d3 = dmg_high_ram_param::W_gate_d3,
		parameter real W_gate_d4 = dmg_high_ram_param::W_gate_d4,
		parameter real W_gate_d5 = dmg_high_ram_param::W_gate_d5,
		parameter real W_gate_d6 = dmg_high_ram_param::W_gate_d6,
		parameter real W_gate_d7 = dmg_high_ram_param::W_gate_d7
	) (
