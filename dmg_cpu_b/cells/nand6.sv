...
module dmg_nand6 #(
		parameter real L_y      = 54 + dmg_nand6_param::L_y,
	...
	specify
		...
		specparam T_fall_y = tpd_elmore(L_y, 6*R_nmos_ohm(35*L_unit), C_gate_F(W_gate_y));

		(in1, in2, in3, in4, in5, in6 *> y) = (T_rise_y, T_fall_y);
	endspecify
