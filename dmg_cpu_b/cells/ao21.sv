...
module dmg_ao21 #(
		parameter real L_y      = 54 + dmg_ao21_param::L_y,
	...
	specify
		specparam T_rise_aoi     = tpd_elmore(112, 2*R_pmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		specparam T_fall_aoi     = tpd_elmore(112, 2*R_nmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		specparam T_fall_aoi_in3 = tpd_elmore(112,   R_nmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		...
		(in3      *> y) = (T_fall_aoi_in3 + T_rise_y, T_rise_aoi + T_fall_y);
	endspecify
