...
package dmg_wave_ram_param;
	...
	parameter real L_dout0       =  87.9;
	parameter real L_dout1       =  87.9;
	parameter real L_dout2       =  87.9;
	parameter real L_dout3       =  87.9;
	parameter real L_dout4       =  87.9;
	parameter real L_dout5       =  87.9;
	parameter real L_dout6       =  87.9;
	parameter real L_dout7       =  87.9;
	parameter real L_din0        = 134.0;
	parameter real L_din1        = 134.0;
	parameter real L_din2        = 134.0;
	parameter real L_din3        = 134.0;
	parameter real L_din4        = 134.0;
	parameter real L_din5        = 134.0;
	parameter real L_din6        = 134.0;
	parameter real L_din7        = 134.0;
