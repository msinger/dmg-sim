...
module dmg_and3 #(
		parameter real L_y      = 54 + dmg_and3_param::L_y,
	...
	specify
		specparam T_rise_nand = tpd_elmore(135,   R_pmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		specparam T_fall_nand = tpd_elmore(135, 3*R_nmos_ohm(35*L_unit), C_gate_F(70*L_unit));
