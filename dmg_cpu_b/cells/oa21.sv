...
module dmg_oa21 #(
	...
	specify
		specparam T_rise_oai     = tpd_elmore(112, R_pmos_ohm(35*L_unit) * 2);
		specparam T_rise_oai_in3 = tpd_elmore(112, R_pmos_ohm(35*L_unit));
		specparam T_fall_oai     = tpd_elmore(112, R_nmos_ohm(35*L_unit) * 2);
