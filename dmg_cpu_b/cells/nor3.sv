...
module dmg_nor3 #(
		parameter real L_y      = 54 + dmg_nor3_param::L_y,
	...
	specify
		specparam T_rise_y = tpd_elmore(L_y, 3*R_pmos_ohm(35*L_unit), C_gate_F(W_gate_y));
