...
module dmg_ao22 #(
		parameter real L_y      = 54 + dmg_ao22_param::L_y,
	...
	specify
		specparam T_rise_aoi = tpd_elmore(151, 2*R_pmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		specparam T_fall_aoi = tpd_elmore(151, 2*R_nmos_ohm(35*L_unit), C_gate_F(70*L_unit));
		...
		(in1, in2, in3, in4 *> y) = (T_fall_aoi + T_rise_y, T_rise_aoi + T_fall_y);
	endspecify
