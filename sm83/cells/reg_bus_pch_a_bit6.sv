...
package sm83_reg_bus_pch_a_bit6_param;
	...
	parameter real L_c_zero_b2 =  9.1;
...
module sm83_reg_bus_pch_a_bit6 #(
		parameter real L_a_y        = 67 + sm83_reg_bus_pch_a_bit6_param::L_a_y,
		parameter real L_b_y        = 61 + sm83_reg_bus_pch_a_bit6_param::L_b_y,
		parameter real L_b_y_n      = 54 + sm83_reg_bus_pch_a_bit6_param::L_b_y_n,
		parameter real L_c_y        = 35 + sm83_reg_bus_pch_a_bit6_param::L_c_y,
		parameter real L_c_y_n      = 57 + sm83_reg_bus_pch_a_bit6_param::L_c_y_n,
		parameter real W_gate_a_y   = 0,
		parameter real W_gate_b_y   = sm83_reg_bus_pch_a_bit6_param::W_gate_b_y,
		parameter real W_gate_b_y_n = 0,
		parameter real W_gate_c_y   = sm83_reg_bus_pch_a_bit6_param::W_gate_c_y,
