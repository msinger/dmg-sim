...
module sm83_reg_bus_pch_a_bit5 #(
		...
		parameter real L_b_y        = 79 + sm83_reg_bus_pch_a_bit5_param::L_b_y,
		parameter real L_b_y_n      = 54 + sm83_reg_bus_pch_a_bit5_param::L_b_y_n,
		parameter real L_c_y        = 83 + sm83_reg_bus_pch_a_bit5_param::L_c_y,
		parameter real L_c_y_n      = 54 + sm83_reg_bus_pch_a_bit5_param::L_c_y_n,
