...
package sm83_dffs_cc_ee_pch_d_reg_pc_bit_param;
	...
	parameter real W_gate_s_n   = 6*L_unit;
	parameter real W_gate_pch_n = 5*L_unit;

endpackage

module sm83_dffs_cc_ee_pch_d_reg_pc_bit #(
		parameter real L_d        = 50 + sm83_dffs_cc_ee_pch_d_reg_pc_bit_param::L_d,
		parameter real L_q        = 50 + sm83_dffs_cc_ee_pch_d_reg_pc_bit_param::L_q,
		parameter real L_q_n      = 68 + sm83_dffs_cc_ee_pch_d_reg_pc_bit_param::L_q_n,
		parameter real W_gate_d   = sm83_dffs_cc_ee_pch_d_reg_pc_bit_param::W_gate_d,
	...
	specify
		...
		specparam T_rise_buf2 = tpd_elmore(   25, 2*R_pmos_ohm( 3*L_unit), C_gate_F(19*L_unit));
		specparam T_fall_buf2 = tpd_elmore(   25, 2*R_nmos_ohm( 3*L_unit), C_gate_F(19*L_unit));
