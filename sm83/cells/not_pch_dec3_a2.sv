...
package sm83_not_pch_dec3_a2_param;

	import sm83_timing::L_unit;

	parameter real L_pch_n =  9.0;
...
module sm83_not_pch_dec3_a2 #(
		parameter real L_in      = 27 + sm83_not_pch_dec3_a2_param::L_in,
		parameter real L_y       = 46 + sm83_not_pch_dec3_a2_param::L_y,
		parameter real W_gate_in = sm83_not_pch_dec3_a2_param::W_gate_in,
