...
package sm83_not_p2_pch_dec3_param;

	import sm83_timing::L_unit;

	parameter real L_pch_n = 15.3;
	parameter real L_in    =  0.0;
	parameter real L_y     =  0.0;

	parameter real W_gate_pch_n =  8*L_unit;
	parameter real W_gate_in    = 38*L_unit;

endpackage

module sm83_not_p2_pch_dec3 #(
		parameter real L_in      = 27 + sm83_not_p2_pch_dec3_param::L_in,
		parameter real L_y       = 46 + sm83_not_p2_pch_dec3_param::L_y,
		parameter real W_gate_in = sm83_not_p2_pch_dec3_param::W_gate_in,
