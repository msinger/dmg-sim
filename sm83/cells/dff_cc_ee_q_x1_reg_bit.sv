...
package sm83_dff_cc_ee_q_x1_reg_bit_param;
...
module sm83_dff_cc_ee_q_x1_reg_bit #(
		parameter real L_q      = 32 + sm83_dff_cc_ee_q_x1_reg_bit_param::L_q,
	...
	specify
		specparam T_rise_buf = tpd_elmore( 23, 2*R_pmos_ohm( 3*L_unit), C_gate_F(15*L_unit));
		specparam T_fall_buf = tpd_elmore( 23, 2*R_nmos_ohm( 3*L_unit), C_gate_F(15*L_unit));
