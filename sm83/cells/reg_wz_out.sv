...
package sm83_reg_wz_out_param;
	...
	parameter real L_pch_n                      =  79.9;
	parameter real L_aoi_in1                    =   0.0;
	parameter real L_aoi_ena1                   =   0.0;
	parameter real L_aoi_ena2                   =   0.0;
	parameter real L_aoi_ena3                   =  23.3;
	parameter real L_aoi_a_in3_muxi_a_d1        =  82.2;
	parameter real L_aoi_b_in3_muxi_b_d1        = 106.9;
	parameter real L_muxi_d0                    =  62.2;
	parameter real L_muxi_a_sel                 =  10.1;
	parameter real L_muxi_a_sel_n               =   0.0;
	parameter real L_muxi_b_sel                 =  12.7;
	parameter real L_muxi_b_sel_n               =  28.5;
	parameter real L_nand_ena                   =   0.0;
	parameter real L_oai21_in_aoi_b_in2         =  12.4;
	parameter real L_oai_ena1                   =   0.0;
	parameter real L_oai_ena2                   =   0.0;
	parameter real L_oai_ena3                   =  12.0;
	parameter real L_oai31_in_nand_in_aoi_a_in2 =   0.0;
	parameter real L_aoi_a_y_n                  =   0.0;
	parameter real L_aoi_b_y                    =  17.0;
	parameter real L_muxi_a_y                   =   0.0;
	parameter real L_muxi_b_y                   =  11.8;
