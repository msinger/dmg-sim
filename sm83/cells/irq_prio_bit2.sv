...
package sm83_irq_prio_bit2_param;
...
module sm83_irq_prio_bit2 #(
		parameter real L_and_y                = 75 + sm83_irq_prio_bit2_param::L_and_y,
		parameter real L_nand_a_y             = 85 + sm83_irq_prio_bit2_param::L_nand_a_y,
		parameter real L_nand_b_y             =  0 + sm83_irq_prio_bit2_param::L_nand_b_y,
		parameter real L_nand_c_y             = 43 + sm83_irq_prio_bit2_param::L_nand_c_y,
		parameter real L_dist_nand_a_y_n      =  0 + sm83_irq_prio_bit2_param::L_dist_nand_a_y_n,
		parameter real L_dist_nand_a_y_p      = 74 + sm83_irq_prio_bit2_param::L_dist_nand_a_y_p,
		parameter real L_dist_nand_b_y_n      = 56 + sm83_irq_prio_bit2_param::L_dist_nand_b_y_n,
		parameter real L_dist_nand_b_y_p      = 74 + sm83_irq_prio_bit2_param::L_dist_nand_b_y_p,
		parameter real L_dist_nor_y_n         = 74 + sm83_irq_prio_bit2_param::L_dist_nor_y_n,
		parameter real L_dist_nor_y_p         = 31 + sm83_irq_prio_bit2_param::L_dist_nor_y_p,
	...
	localparam realtime T_fall_nand_b_y = tpd_elmore(L_nand_b_y, 4*R_nmos_ohm(6*L_unit), C_gate_F(W_gate_nand_b_y));
