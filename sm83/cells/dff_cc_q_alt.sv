...
package sm83_dff_cc_q_alt_param;

	import sm83_timing::L_unit;

	parameter real L_d     =  0.0;
	parameter real L_clk   =  0.0;
	parameter real L_clk_n = 24.0;
...
module sm83_dff_cc_q_alt #(
		parameter real L_q      = 17 + sm83_dff_cc_q_alt_param::L_q,
	...
	specify
		specparam T_rise_buf = tpd_elmore( 65, 2*R_pmos_ohm( 3*L_unit), C_gate_F( 6*L_unit));
		specparam T_fall_buf = tpd_elmore( 65, 2*R_nmos_ohm( 3*L_unit), C_gate_F( 6*L_unit));
		specparam T_rise_not = tpd_elmore( 58,   R_pmos_ohm( 3*L_unit), C_gate_F(16*L_unit));
		specparam T_fall_not = tpd_elmore( 58,   R_nmos_ohm( 3*L_unit), C_gate_F(16*L_unit));
