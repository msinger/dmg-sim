...
module sm83_and2_alu #(
		parameter real L_y      = 37 + sm83_and2_alu_param::L_y,
	...
	specify
		specparam T_rise_nand = tpd_elmore( 44,   R_pmos_ohm( 5*L_unit), C_gate_F(16*L_unit));
		specparam T_fall_nand = tpd_elmore( 44, 2*R_nmos_ohm( 5*L_unit), C_gate_F(16*L_unit));
		specparam T_rise_y    = tpd_elmore(L_y,   R_pmos_ohm(11*L_unit), C_gate_F(W_gate_y));
