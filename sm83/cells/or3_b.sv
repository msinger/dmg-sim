...
module sm83_or3_b #(
		parameter real L_y      = 15 + sm83_or3_b_param::L_y,
	...
	specify
		specparam T_rise_nor = tpd_elmore( 51, 3*R_pmos_ohm(3*L_unit), C_gate_F(10*L_unit));
		specparam T_fall_nor = tpd_elmore( 51,   R_nmos_ohm(3*L_unit), C_gate_F(10*L_unit));
