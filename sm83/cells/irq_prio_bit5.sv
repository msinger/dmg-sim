...
package sm83_irq_prio_bit5_param;
	...
	parameter real L_nand_c_y           = 24.6;
	parameter real L_nand_c_y_n         =  0.0;
	...
	parameter real W_gate_nand_c_y           = 12*L_unit;

endpackage

module sm83_irq_prio_bit5 #(
		parameter real L_and_y                = 73 + sm83_irq_prio_bit5_param::L_and_y,
		parameter real L_nand_a_y             = 77 + sm83_irq_prio_bit5_param::L_nand_a_y,
		parameter real L_nand_b_y             =  0 + sm83_irq_prio_bit5_param::L_nand_b_y,
		parameter real L_nand_c_y             = 98 + sm83_irq_prio_bit5_param::L_nand_c_y,
		parameter real L_nand_c_y_n           = 88 + sm83_irq_prio_bit5_param::L_nand_c_y_n,
		parameter real L_nand_d_y             = 77 + sm83_irq_prio_bit5_param::L_nand_d_y,
		parameter real L_dist_nand_a_y_n      =  0 + sm83_irq_prio_bit5_param::L_dist_nand_a_y_n,
		parameter real L_dist_nand_a_y_p      = 77 + sm83_irq_prio_bit5_param::L_dist_nand_a_y_p,
		parameter real L_dist_nand_b_y_n      = 55 + sm83_irq_prio_bit5_param::L_dist_nand_b_y_n,
		parameter real L_dist_nand_b_y_p      = 77 + sm83_irq_prio_bit5_param::L_dist_nand_b_y_p,
		parameter real L_dist_nor_y_n         = 77 + sm83_irq_prio_bit5_param::L_dist_nor_y_n,
		parameter real L_dist_nor_y_p         = 31 + sm83_irq_prio_bit5_param::L_dist_nor_y_p,
		parameter real W_gate_and_y           = 0,
		parameter real W_gate_nand_a_y        = 0,
		parameter real W_gate_nand_b_y        = 0,
		parameter real W_gate_nand_c_y        = sm83_irq_prio_bit5_param::W_gate_nand_c_y,
		parameter real W_gate_nand_c_y_n      = 0,
	...
	localparam realtime T_fall_nand_b_y = tpd_elmore(L_nand_b_y, 7*R_nmos_ohm(6*L_unit), C_gate_F(W_gate_nand_b_y));
	...
	localparam realtime T_rise_nand_c_y = tpd_elmore(L_nand_c_y,   R_pmos_ohm(6*L_unit), C_gate_F(W_gate_nand_c_y));
	...
	bufif0 (strong1, highz0) #(T_rise_nand_c_y, T_fall_nand_c_y, T_Z_nand_c_y) (nand_c_y, '1, pch_n);
	bufif1 (highz1, strong0) #(T_rise_nand_c_y, T_fall_nand_c_y, T_Z_nand_c_y) (nand_c_y, '0, pch_n & and_y);
	...
	bufif1 (highz1, strong0) #(T_Z_nand_d_y, T_fall_nand_d_y, T_Z_nand_d_y) (nand_d_y, '0, pch_n & and_y);
	...
	specify
		specparam T_rise_nand_c_y_n = tpd_elmore(L_nand_c_y_n, R_pmos_ohm(6*L_unit), C_gate_F(W_gate_nand_c_y_n));
		specparam T_fall_nand_c_y_n = tpd_elmore(L_nand_c_y_n, R_nmos_ohm(6*L_unit), C_gate_F(W_gate_nand_c_y_n));
