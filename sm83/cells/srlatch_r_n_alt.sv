...
module sm83_srlatch_r_n_alt #(
	...
	specify
		specparam T_rise_sr = tpd_elmore( 51,   R_pmos_ohm(13.5*L_unit), C_gate_F(16*L_unit));
		specparam T_fall_sr = tpd_elmore( 51, 2*R_nmos_ohm(13.5*L_unit), C_gate_F(16*L_unit));
