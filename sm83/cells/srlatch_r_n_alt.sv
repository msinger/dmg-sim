...
package sm83_srlatch_r_n_alt_param;
	...
	parameter real W_gate_s   = 13.5*L_unit;
	parameter real W_gate_r_n = 27.0*L_unit;

endpackage

module sm83_srlatch_r_n_alt #(
		parameter real L_q      = 19 + sm83_srlatch_r_n_alt_param::L_q,
	...
	specify
		specparam T_rise_sr = tpd_elmore( 42,   R_pmos_ohm(16.5*L_unit), C_gate_F(16*L_unit));
		specparam T_fall_sr = tpd_elmore( 42, 2*R_nmos_ohm(16.5*L_unit), C_gate_F(16*L_unit));
