...
module sm83_oa21_reg #(
		parameter real L_y      = 22 + sm83_oa21_reg_param::L_y,
	...
	specify
		specparam T_rise_oai     = tpd_elmore( 20, 2*R_pmos_ohm(3*L_unit), C_gate_F(14*L_unit));
		specparam T_rise_oai_in3 = tpd_elmore( 20,   R_pmos_ohm(3*L_unit), C_gate_F(14*L_unit));
		specparam T_fall_oai     = tpd_elmore( 20, 2*R_nmos_ohm(3*L_unit), C_gate_F(14*L_unit));
