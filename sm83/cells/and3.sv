...
module sm83_and3 #(
		parameter real L_y      = 19 + sm83_and3_param::L_y,
	...
	specify
		specparam T_rise_nand = tpd_elmore( 88,   R_pmos_ohm(3*L_unit), C_gate_F(6*L_unit));
		specparam T_fall_nand = tpd_elmore( 88, 3*R_nmos_ohm(3*L_unit), C_gate_F(6*L_unit));
