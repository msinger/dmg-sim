...
package sm83_nand2_in1_n_a_param;
...
module sm83_nand2_in1_n_a #(
		parameter real L_y      = 33 + sm83_nand2_in1_n_a_param::L_y,
	...
	specify
		specparam T_rise_in1 = tpd_elmore( 16,   R_pmos_ohm(3*L_unit), C_gate_F(6*L_unit));
		specparam T_fall_in1 = tpd_elmore( 16,   R_nmos_ohm(3*L_unit), C_gate_F(6*L_unit));
