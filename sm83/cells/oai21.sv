...
package sm83_oai21_param;

	import sm83_timing::L_unit;

	parameter real L_in1 = 17.3;
...
module sm83_oai21 #(
		parameter real L_y      = 34 + sm83_oai21_param::L_y,
	...
	specify
		...
		specparam T_rise_y_in3 = tpd_elmore(L_y,   R_pmos_ohm(3*L_unit), C_gate_F(W_gate_y));
