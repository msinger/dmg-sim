...
package sm83_irq_prio_bit1_param;

	import sm83_timing::L_unit;

	parameter real L_pch_n              =  0.0;
	parameter real L_and_in1            = 36.4;
	parameter real L_and_in2_nand_a_in2 = 19.6;
	...
	parameter real W_gate_pch_n              = 18*L_unit;
...
module sm83_irq_prio_bit1 #(
		parameter real L_and_y                = 75 + sm83_irq_prio_bit1_param::L_and_y,
		parameter real L_nand_a_y             = 89 + sm83_irq_prio_bit1_param::L_nand_a_y,
		parameter real L_nand_b_y             =  0 + sm83_irq_prio_bit1_param::L_nand_b_y,
		parameter real L_nand_c_y             = 43 + sm83_irq_prio_bit1_param::L_nand_c_y,
		parameter real L_dist_nand_a_y_n      =  0 + sm83_irq_prio_bit1_param::L_dist_nand_a_y_n,
		parameter real L_dist_nand_a_y_p      = 74 + sm83_irq_prio_bit1_param::L_dist_nand_a_y_p,
		parameter real L_dist_nand_b_y_n      = 56 + sm83_irq_prio_bit1_param::L_dist_nand_b_y_n,
		parameter real L_dist_nand_b_y_p      = 74 + sm83_irq_prio_bit1_param::L_dist_nand_b_y_p,
		parameter real L_dist_nor_y_n         = 74 + sm83_irq_prio_bit1_param::L_dist_nor_y_n,
		parameter real L_dist_nor_y_p         = 31 + sm83_irq_prio_bit1_param::L_dist_nor_y_p,
	...
	localparam realtime T_fall_nand_b_y = tpd_elmore(L_nand_b_y, 3*R_nmos_ohm(6*L_unit), C_gate_F(W_gate_nand_b_y));
	localparam realtime T_Z_nand_b_y    = tpd_z(, T_fall_nand_b_y);
	bufif1 (highz1, strong0) #(T_Z_nand_b_y, T_fall_nand_b_y, T_Z_nand_b_y) (nand_b_y, '0, pch_n & nand_b_in2 & nand_b_in3);
